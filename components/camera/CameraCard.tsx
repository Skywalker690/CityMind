...
import { Camera, ImageUp, RotateCcw, ScanLine, Sparkles, X } from "lucide-react";
  ...
  return (
    <Card className="overflow-hidden">
      ...
      <CardContent className="space-y-4">
        ...
        {camera.error ? (
          <p className="text-sm text-amber-600 dark:text-amber-300">{camera.error}</p>
        ) : null}
        ...
        />
        <AnalysisSteps active={analyzing} complete={status === "ready"} />
      </CardContent>
    </Card>
  );
}
